    ...
    <div class="main container my-3">
        <aside>
            ...
            <ul class="nav flex-column" id="mw-admin-main-navigation">
                ...
                <?php if (user_can_view_module(['module' => 'content']) && $user_id == 1): ?>
                ...
                <li <?php print 'class="nav-item dropdown ' . ($load_module == 'scan_codeTQ' ? 'active' : '') . '"'; ?>>
                    <a class="nav-link <?php print ($load_module == 'scan_codeTQ' OR $view == 'roles') ? 'active' : ''; ?>" href="<?php print admin_url('view:modules/load_module:scan_codeTQ'); ?>">
                        <i class="mdi mdi-shopping"></i> <?php _e("Quét mã (TQ)"); ?>
                    </a>
                </li>
                <?php if($user_id == 1): ?>
                <li <?php print 'class="nav-item dropdown ' . ($load_module == 'bill_code' ? 'active' : '') . '"'; ?>>
                 ...
                 <li <?php print 'class="nav-item dropdown ' . ($load_module == 'scan_codeVN' ? 'active' : '') . '"'; ?>>
                    <a class="nav-link <?php print ($load_module == 'scan_codeVN' OR $view == 'roles') ? 'active' : ''; ?>" href="<?php print admin_url('view:modules/load_module:scan_codeVN'); ?>">
                        <i class="mdi mdi-shopping"></i> <?php _e("Quét mã (VN)"); ?>
                    </a>
                </li>
